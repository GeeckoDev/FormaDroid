...
public class Preference extends PreferenceActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.setEntries("estts_pref", new CharSequence[]{}, new CharSequence[]{});
		this.setEntries("depts_pref", new CharSequence[]{}, new CharSequence[]{});
		this.setEntries("groups_pref", new CharSequence[]{}, new CharSequence[]{});
	}
}